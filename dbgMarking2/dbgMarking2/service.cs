            ...
            if (File.Exists(sfPath))
            {
                ...
                if (fc.Length > 0)
                {
                    ...
                    if (sf.a02_Plant.EndsWith("@@"))
                    {
                        ...
                        if (cnt > 0)
                        {
                            ret = mr.FirstOrDefault().a02_MData1.Trim();
            ...
            if (File.Exists(sfPath))
            {
                ...
                if (fc.Length > 0)
                {
                    ...
                    if (sf.a03_ProdCode.Contains("@@@"))
                    {
                        ...
                        if (cnt > 0)
                        {
                            ret = mr.FirstOrDefault().a02_MData1.Trim().Substring(0, mr.FirstOrDefault().a02_MData1.Length - sf.a02_Plant.Length);
                            ...
                            if (match.Length > 0)
                            {
                                ...
                                if (cnt > 0)
                                {
                                    int SerialChar = sf.a02_Plant.Length;
                                    ...
                                    while (lastSerialCode.ToUpper() != firstSeq)
                                    {
                                        ...
                                        lastSerialCode = mr[mr.Count - 1].a02_MData1.Substring(0, mr[0].a02_MData1.Length - SerialChar);
                                        ...
                                        serialCode = mr[0].a02_MData1.Substring(0, mr[0].a02_MData1.Length - sf.a02_Plant.Length);
                                    }
                                    ...
                                    else
                                    {
                                        ...
                                        for (int i = mr.Count - 1; i >= 0; i--)
                                        {
                                            ...
                                            {
                                                int _seqCnt = 0;
                                                bool convertSequence = int.TryParse(dataSerialCode, out _seqCnt);
                        ...
                        else
                        {
                            ...
                            if (cnt > 0)
                            {
                                string serialCode = mr[0].a02_MData1.Substring(0, mr[0].a02_MData1.Length - sf.a02_Plant.Length);
                                string lastSerialCode = mr[mr.Count - 1].a02_MData1.Substring(0, mr[mr.Count - 1].a02_MData1.Length - sf.a02_Plant.Length);
                                ...
                                while (lastSerialCode.ToUpper() != firstSeq)
                                {
                                    ...
                                    lastSerialCode = mr[mr.Count - 1].a02_MData1.Substring(0, mr[mr.Count - 1].a02_MData1.Length - sf.a02_Plant.Length);
                                ...
                                else
                                {
                                    ...
                                    for (int i = mr.Count - 1; i >= 0; i--)
                                    {
                                        ...
                                        {
                                            int _seqCnt = 0;
                                            bool convertSeq = int.TryParse(dataSerialCode, out _seqCnt);
